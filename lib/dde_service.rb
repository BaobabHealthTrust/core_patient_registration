...
module DDEService
  ...
  def self.create_remote(received_params)
    ...
    demographic_servers = JSON.parse(CoreGlobalProperty.find_by_property("demographic_server_ips_and_local_port").property_value) rescue []
  ...
  def self.search_by_identifier(identifier)
    ...
    # TODO handle the birthplace attribute
        ...
        patient.patient_identifiers.create("identifier" => identifier, "identifier_type" => identifier_type.patient_identifier_type_id)
		  ...
		  #patient.patient_identifiers.create("identifier" => patient_params["identifier"], "identifier_type" => CorePatientIdentifierType.find_by_name("Unknown id")) unless params["identifier"].blank?
		end
  ...
  def self.get_remote_person(dde_person_id)
    ...
    return CorePerson.create_from_form(passed["person"])
  end
